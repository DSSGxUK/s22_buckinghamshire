...
# DVC Params
from src.constants import SCHOOL_CENSUS_COLUMN_RENAME, NA_VALS
...
parser.add_argument("--input", required=True, help="where to find the input census csv")
parser.add_argument(
    "--output", required=True, help="where to put the output canonicalized census csv"
)
...
if __name__ == "__main__":
    ...
    census_dfs = {
        k: df.rename(columns=SCHOOL_CENSUS_COLUMN_RENAME)
