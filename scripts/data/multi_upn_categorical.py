...
parser.add_argument('--input', required=True,
                    help='where to find merged multi upn dataset')
parser.add_argument('--output', required=True,
                    help='where to put merged multi upn categorical dataset')
parser.add_argument('--include_test_taken_code', action='store_true',
...
if __name__ == "__main__":
    ...
    sen_need_values = sorted(set.union(
