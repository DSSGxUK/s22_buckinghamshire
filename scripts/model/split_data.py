...
parser.add_argument('--split', type=float,
                    help='The percentage of upns to hold out in the test set')
parser.add_argument('--input', required=True,
                    help='where the input csv is located')
parser.add_argument('--train_output', required=True,
                    help='where the output train csv is located')
parser.add_argument('--test_output', required=True,
                    help='where the output test csv is located')
...
if __name__ == '__main__':
 ...
 # Split data into train and test [stratify on target column]
    ...
    if args.single:
        logger.info(f'Performing train test split with test_split {args.split} stratified on {args.target} on the single upn dataset')
        ...
        logger.info(f'Writing training data to {train_output_fp} and writing test data to {test_output_fp}')
        ...
        logger.info(f'Performing train test split with test_split {args.split} stratified on {args.target} on multi-upn dataset')
