...
parser.add_argument('--train_data', required=True,
                    help='where the train data csv is located')
parser.add_argument('--test_data', required=True,
                    help='where the test data csv is located')
parser.add_argument('--output_test_metrics', required=True,
...
if __name__ == '__main__':
    ...
    for th in thresholds :
        ...
        print ('Threshold', th)
        print ('recall_score :',recall_score(df[TARGET].astype('int64'),roni_df['y_pred_'+str(th)]))
        print ('precision_score',         precision_score(df[TARGET].astype('int64'),roni_df['y_pred_'+str(th)]))
        print ('f1_score',         f1_score(df[TARGET].astype('int64'),roni_df['y_pred_'+str(th)]))
        print ('fbeta_score',         fbeta_score(df[TARGET].astype('int64'),roni_df['y_pred_'+str(th)],beta=2))

        fscores.append(f1_score(df[TARGET].astype('int64'),roni_df['y_pred_'+str(th)]))
        fbetas.append(fbeta_score(df[TARGET].astype('int64'),roni_df['y_pred_'+str(th)],beta=2))
