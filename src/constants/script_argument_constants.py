...
MULTI_UPN_CATEGORICAL_TO_SINGLE_AGGS = {
    ...
    KSDataColumns.deprivation_indicator_idaci_score: Aggregations.last,
    KSDataColumns.is_the_pupil_disadvantaged: Aggregations.max,
    KSDataColumns.is_the_pupil_looked_after: Aggregations.max,
    KSDataColumns.ks2_aps_va: Aggregations.mean,
    KSDataColumns.ks2_aps_cubed: Aggregations.mean,
    KSDataColumns.ks2_aps_squared: Aggregations.mean,
    KSDataColumns.ks2_english_ps: Aggregations.mean,
    KSDataColumns.ks2_english_ps_deviation: Aggregations.mean,
    KSDataColumns.ks2_maths_ps: Aggregations.mean,
    KSDataColumns.ks2_maths_ps_deviation: Aggregations.mean,
    KSDataColumns.ks2_prior_band: Aggregations.mean,
    KSDataColumns.ks2_reading_ps: Aggregations.mean,
    ...
    KSDataColumns.ks2_english: Aggregations.mean,
    KSDataColumns.ks2_mathematics: Aggregations.mean,
    KSDataColumns.ks2_english_ta: Aggregations.mean,
    KSDataColumns.ks2_english_ta_level: Aggregations.mean,
    KSDataColumns.ks2_english_level_finely_graded: Aggregations.mean,
    KSDataColumns.ks2_mathematics_ta: Aggregations.mean,
    KSDataColumns.ks2_mathematics_ta_level: Aggregations.mean,
    KSDataColumns.ks2_mathematics_level_finely_graded: Aggregations.mean,
    KSDataColumns.ks2_reading_ta_level: Aggregations.mean,
    KSDataColumns.ks2_reading_level_finely_graded: Aggregations.mean,
    KSDataColumns.ks2_mathematics_finely_graded: Aggregations.mean,
    KSDataColumns.sen: Aggregations.categorical_max,
    KSDataColumns.ks2_english + CODED_SUFFIX: Aggregations.categorical_max,
