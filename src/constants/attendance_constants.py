...
class _AbsenceReasons(
    _AuthorisedAbsenceReasons,
    _UnauthorisedAbsenceReasons,
    _ApprovedActivities
):
    pass
...
@dataclass
class _AttendanceOriginalDataColumns(
    _AbsenceReasons,
    _NonabsenceReasons
):
...
@dataclass
class _AttendanceDataColumns(_AttendanceOriginalDataColumns, _AttendanceAddedDataColumns):
    pass
