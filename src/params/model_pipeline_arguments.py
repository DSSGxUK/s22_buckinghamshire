...
RONI_PARAMS = {'train_data':SINGLE_TRAIN_FP,
              'test_data':SINGLE_TEST_FP,
               'output_test_metrics':RONI_TEST_RESULTS,
              'target':TARGET}

RETRAIN_SINGLE_PARAMS = {'input':SINGLE_TRAIN_FP,
                        'single':True,
...
TEST_SINGLE_PARAMS = {'input': SINGLE_TEST_FP,
                        'single':True,
...
PREDICT_SINGLE_PARAMS = {'input': FS_SINGLE_UPN_CATEGORICAL_PREDICT_FP,
                        'single':True,
...
UNKNOWNS_SINGLE_PARAMS = {'input': FS_SINGLE_UPN_CATEGORICAL_UNKNOWNS_FP,
                        'single':True,
